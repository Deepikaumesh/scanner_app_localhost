...
$findexist="select * from admin_registration where username='".$username."'";
    ...
    $sql = "INSERT INTO admin_registration (username,email,phone,password) VALUES ('".$username."','".$email."','".$phone."','".$password."')";
